<div class="bangladesh-map">
  <h2>Select your area doctors</h2>
      <svg
        version="1.1"
        id="Layer_1"
        ...
        style="enable-background: new -201 -372.5 560 776.5"
        xml:space="preserve"
      >
        <g id="border">
          <g id="shadow">
        ...
        <g id="rangpur">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/Rangpur"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/Rangpur"
          >
            <path
              class="st3"
        ...
        <g id="sylhet">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/sylhet"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/sylhet"
          >
            <path
              class="st3"
        ...
        <g id="khulna">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/khulna"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/khulna"
          >
            <path
              class="st3"
            ...
            <g class="st16">
              ...
              <g>
                ...
                <g>
                  <path
                    class="st17"
                    d="M-19.5,99.4v16.2H-22V99.4h-2.6v-2.2h7.5v2.2H-19.5z"
                  ></path>
                </g>
              </g>
            </g>
        ...
        <g id="dhaka" title="dhaka Doctors">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/dhaka"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/dhaka"
          >
            <path
              class="st3"
            ...
            <g class="st16">
              ...
              <g>
                ...
                <g>
                  <path
                    class="st17"
                    d="M71.7-29.7v20.3h-3.1v-20.3h-3.3v-2.8h9.5v2.8H71.7z"
                  ></path>
                </g>
                <g>
                  <path
                ...
                <g>
                  <path
                    class="st17"
                    d="M104.3-29.7v20.3h-3.1v-20.3h-3.3v-2.8h9.5v2.8H104.3z"
                  ></path>
                </g>
              </g>
            </g>
        ...
        <g id="mymensingh">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/mymensingh"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/mymensingh"
          >
            <path
              class="st3"
        ...
        <g id="rajshahi">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/rajshahi"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/rajshahi"
          >
            <path
              class="st14"
            ...
            <g class="st16">
              ...
              <g>
                ...
                <g>
                  <path
                    class="st17"
                    d="M-117.2-113.4v14.7h-2.3v-14.7h-2.4v-2h6.9v2H-117.2z"
                  ></path>
                </g>
                <g>
                  <path
                ...
                <g>
                  <path
                    class="st17"
                    d="M-76.5-113.4v14.7h-2.3v-14.7h-2.4v-2h6.9v2H-76.5z"
                  ></path>
                </g>
                <g>
                  <path
        ...
        <g id="barisal">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/barisal"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/barisal"
          >
            <path
              class="st13"
            ...
            <g class="st16">
              ...
              <g class="map-icon">
                ...
                <g>
                  <path
                    class="st17"
                    d="M91.2,173.7v14.1H89v-14.1h-2.3v-1.9h6.6v1.9H91.2z"
                  ></path>
                </g>
                <g>
                  <path
        ...
        <g id="chattogram">
          <a
            href="<?php echo site_url(); ?>/doctor-locations/chattogram"
            xlink:href="<?php echo site_url(); ?>/doctor-locations/chattogram"
          >
            <path
              class="st11"
            ...
            <g class="st16">
              ...
              <g class="map-icon">
                ...
                <g>
                  <path
                    class="st17"
                    d="M315.8,197.7v15.7h-2.4v-15.7h-2.5v-2.1h7.3v2.1H315.8z"
                  ></path>
                </g>
                <g>
                  <path
