...
$details = get_taxonomy_term_details($current_term->term_id, 'service-category');
// Use the function to get total post count for the current term and its descendants
$product_count = get_term_post_count($current_term->term_id, 'service-category');
?>
...
<section class="bg-gray-100 py-16">
    <div class="container mx-auto px-4">
        <div class="mb-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo esc_url(home_url('/service-category')); ?>" class="ml-1 text-gray-700 hover:text-emerald-600 md:ml-2">service-category</a>
                        </div>
                    </li>
            ...
            <?php display_featured_menus('service-category', 10, ''); ?>
        </div>
    </div>
</section>
