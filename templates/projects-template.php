            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-500 md:ml-2">Projects</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                if ($projects_query->have_posts()) :
                    ...
                    while ($projects_query->have_posts()) : $projects_query->the_post();
                        ...
                        $project_details = get_field('common_fields', $project_id);
                        ?>
                        <div class="group relative overflow-hidden rounded-lg shadow-lg">
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-6">
                                ...
                                <?php endif; ?>
                                <a href="<?php the_permalink(); ?>" class="text-xl font-bold text-white hover:text-green-500 transition-colors duration-300">
                                    <h3 class="text-xl font-bold text-white hover:text-green-500 transition-colors duration-300"><?php the_title(); ?></h3>
                                </a>
                            </div>
                        </div>
                    <?php
