<section class="py-16">
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-10">
      <h2 class="text-sm font-semibold text-green-600 tracking-wide uppercase">Our Services</h2>
        ...
        <div class="group bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
          ...
          <div class="p-6">
            <a href="<?php the_permalink(); ?>" class="block">
              <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-700 transition-colors duration-300 mb-3"><?php the_title(); ?></h3>
            </a>
            <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo $excerpt; ?></p>
    ...
    <div class="!mt-10 text-center">
        <a href="<?php echo site_url('/services'); ?>" class="group inline-flex items-center px-6 py-3 border border-transparent text-lg font-medium rounded-full text-white bg-green-700 hover:bg-green-800 transition-bg duration-300 shadow hover:shadow-lg">
          View All Services
